...
\cmd{:$r$'$a$,'$b$g/$p$/j}{join any line containing the string $p$ to its subsequent line, if it lies between the $a$ and $b$ marks}
...
\cmd{\ctrl Wo \ctrl Wc }{close all other/current window(s)}
